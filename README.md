...
**НЕЧТО — ПРОТОКОЛ ЗАРАЖЕНИЯ** — локальная цифровая игра для компании от 4 до 12 человек.
...
**Большой экран** — карта корабля: позиции игроков, двери, карантины, лог событий.
Там нет секретной информации — только то, что произошло при всех.

**Телефон** — личный терминал: рука карт, выбор действий, обмены.
